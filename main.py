...
import motor_pair
import sys
from motor import BRAKE, ERROR, SMART_BRAKE
import color_sensor
...
async def MissionRedBlue():
    ...
    # await gyro_straight(60,high_speed)
        ...
        await gyro_straight(30,high_speed)
        await gyro_turn_left(10,ultraslow_speed)
...
async def Multimash():
    await robot_setup()
    await motor.run_for_degrees(hammer,-90,medium_speed) #Why does the hammer never come down 
...
async def ThorPart2():
    ...
    await motor.run_for_degrees(flipper,-20, medium_speed)
    await gyro_turn_left(90,medium_speed)
...
async def ThorPart3():
    ...
    await gyro_back(8,slow_speed)
    await gyro_turn_left(40,medium_speed)
    await gyro_straight(12.5,ultraslow_speed)
    await motor.run_for_degrees(hammer,60,medium_speed)#
    await gyro_turn_left(25,medium_speed)
    await gyro_straight(3,slow_speed)
    await gyro_turn_left(50,medium_speed)#
    await motor.run_for_degrees(hammer,35,slow_speed)
    #Going home
    await motor.run_for_degrees(hammer,-90,medium_speed)
    await gyro_turn_right(10,medium_speed)
    await gyro_back(70,medium_speed)
    await gyro_turn_right(25,medium_speed)
    await gyro_back(11.5,high_speed)
    await gyro_turn_right(40,medium_speed)
    await gyro_straight(8,high_speed)
    await gyro_straight(1,medium_speed)
    await gyro_back(2,high_speed)
    await gyro_turn_left(45,medium_speed)
    await gyro_back(23,silly_speed)
    await gyro_turn_left(45,medium_speed)
    await gyro_back(18,silly_speed)
    await gyro_turn_right(45,medium_speed)
    await gyro_straight(10,silly_speed)
    await gyro_back(37.5,silly_speed)
    await emergency_stop()
...
async def slapathing():
        await robot_setup()
        await motor.run_for_degrees(hammer,-90,medium_speed)
        await gyro_straight(47,high_speed)
        await gyro_turn_left(90,slow_speed)
        await gyro_straight(20,medium_speed)
        await gyro_turn_right(90,medium_speed)
        await gyro_straight(37,high_speed)
        ...
        await motor.run_for_degrees(hammer,-80,high_speed)
        await gyro_straight(100,medium_speed)
        
        #await gyro_turn_right(6,medium_speed)
        #await gyro_back(50,medium_speed)
        #await gyro_turn_left(58,medium_speed)
        #await motor.run_for_degrees(hammer,137,medium_speed)
...
async def hulksmash2(): # Needs work
    await robot_setup()
    await gyro_straight (30,medium_speed)
    await gyro_turn_right (179,medium_speed)
    await gyro_back (27,medium_speed)
    await motor.run_for_degrees(flipper,-90,medium_speed)
    await gyro_back(5,medium_speed)
    await motor. run_for_degrees(flipper,90,medium_speed)
    await gyro_back(3,medium_speed)
    await gyro_turn_left(90,medium_speed)
    await gyro_straight(1,medium_speed)
    await gyro_turn_right(90,medium_speed)
...
async def grindstone(): #Set to #10 - Mission to go get hook at back of the board
    await robot_setup()
    await gyro_straight(5,slow_speed)
    await gyro_turn_left(135,slow_speed)
    await gyro_back(32,slow_speed)
    await gyro_turn_left(40,slow_speed)
    await gyro_back(45,slow_speed)
    await motor.run_for_degrees(flipper,62,supaslow)
    await gyro_turn_left(10,medium_speed)
    await gyro_straight(4.5,supaslow)
    await motor.run_for_degrees(flipper,-65,supaslow)
   # await gyro_turn_left(40,supaslow)
    await gyro_straight(38,slow_speed)
    await gyro_turn_right(45,slow_speed)
    await gyro_straight(32,slow_speed)
    

async def MountainStuff_v2():
    await robot_setup()
    await motor.run_for_degrees(hammer,-120,medium_speed)
    await gyro_straight(67,high_speed)
    await gyro_turn_right(40,medium_speed)
    await gyro_back(2,medium_speed)
    await motor.run_for_degrees(hammer,55,medium_speed)
    await gyro_turn_left(45,medium_speed)
    sleep_ms(500)
    await motor.run_for_degrees(hammer,13,medium_speed)
    await gyro_straight(2,medium_speed)
    await gyro_turn_left(80,supaslow)
    await motor.run_for_degrees(hammer,-90,high_speed)
    await gyro_straight(62,high_speed)
    await gyro_turn_left(136,medium_speed)
    await motor.run_for_degrees(hammer,180,high_speed)
    await gyro_straight(200,high_speed)
    sleep_ms(500)
    await gyro_back(11,silly_speed)
    await motor.run_for_degrees(hammer,-180,high_speed)
    await gyro_turn_right(40,medium_speed)
   # await motor.run_for_degrees(hammer,90,high_speed)
    ...
    await gyro_turn_right(90,medium_speed)
    await gyro_turn_right(90,medium_speed)
    await gyro_straight(3,medium_speed)
    await motor.run_for_degrees(hammer,180,high_speed)
    await motor.run_for_degrees(hammer,-180,high_speed)
    await gyro_turn_left(90,medium_speed)
    await gyro_straight(3,medium_speed)
    await gyro_turn_left(85,medium_speed)
    await gyro_straight(90, high_speed)




async def MountainStuff(): #set to 15?
# missions bolder, flip sand, and foodstand setup
    await robot_setup()    
    await motor.run_for_degrees(hammer,-90,medium_speed)
    await gyro_straight(30,medium_speed)
    await gyro_turn_left(45,medium_speed)
    ...
    await gyro_turn_right(45,medium_speed)
    await motor.run_for_degrees(flipper,90,medium_speed)
    await gyro_straight(11,medium_speed)
    await gyro_turn_left(125,slow_speed)
    await gyro_back(5,slow_speed)
    await gyro_turn_left(80,silly_speed)
    #await motor.run_for_degrees(flipper,-110,medium_speed)
    #await gyro_straight(2,medium_speed)
    #await gyro_turn_right(105,medium_speed)
    #await motor.run_for_degrees(flipper,-90,medium_speed)
    #await gyro_straight(52,medium_speed)
    #await gyro_turn_left(50,medium_speed)
    #await motor.run_for_degrees(hammer,90,silly_speed)
    #await gyro_straight(50,silly_speed)
    #await gyro_turn_right(40,medium_speed)
    #await gyro_turn_left(45,medium_speed)
    #await gyro_straight(39,medium_speed)#was straight
    #await gyro_turn_left(90,medium_speed)
   # await gyro_straight(7,medium_speed)
    #await gyro_turn_left(90,slow_speed)
    #await gyro_back(2,slow_speed)
    #await gyro_turn_left(90,medium_speed)
    #sleep_ms(500)
    #await gyro_straight(30,medium_speed)
    #sleep_ms(500)
    ...
    #await gyro_straight(90,high_speed)
    sleep_ms(500)
    # i am done with this code, ready to test and edit -joel


async def grindstone_v2():
    await robot_setup()
    await gyro_straight(30,medium_speed)
    await gyro_turn_left(45,medium_speed)
    await gyro_straight(17,medium_speed)
    ...
    await motor.run_for_degrees(hammer,-90,medium_speed)
    await gyro_turn_left(25,medium_speed)
    await motor.run_for_degrees(hammer, 90,supaslow)
    await gyro_turn_right(25,medium_speed)
    await gyro_back(7,medium_speed)
    await gyro_turn_right(45,medium_speed)
    await gyro_back(17,medium_speed)
    await gyro_turn_left(90,medium_speed)
    await gyro_back(27,medium_speed)
    await gyro_turn_left(45,medium_speed)
    await gyro_back(17,medium_speed)
    await gyro_turn_right(45,medium_speed)
    await gyro_back(40,medium_speed)
    await emergency_stop()
...
async def MissionRedBlue_v2():
    ...
    # from Red Side (left side) - We need to figure out positioning
        ...
        await motor.run_for_degrees(hammer,-90,high_speed) #putting the hammer up so we know where we are starting
    # await gyro_straight(60,high_speed)
        await gyro_straight(56,high_speed)#Why do we go straight and then straight again
        await motor.run_for_degrees(hammer,74,high_speed)
        await gyro_turn_left(130,medium_speed)
        #await gyro_straight(27,medium_speed)
        ...
        await gyro_turn_right(65,medium_speed)
        await motor.run_for_degrees(hammer,130,high_speed)
        await gyro_straight(31,high_speed)
        await gyro_turn_left(16,ultraslow_speed)
        await motor.run_for_degrees(hammer,-265,supaslow)
        await gyro_back(20,medium_speed)
        await motor.run_for_degrees(hammer,200,medium_speed)
        await gyro_turn_left(100,medium_speed)
        await gyro_straight(16,medium_speed)
        #await gyro_turn_right(45,medium_speed)
        await gyro_straight(9,medium_speed)
        await gyro_turn_left(1,medium_speed)
        await motor.run_for_degrees(hammer,-20,medium_speed)
        await gyro_straight(8,medium_speed)
        await motor.run_for_degrees(hammer,-25,medium_speed)
        await gyro_turn_right(93,medium_speed)
        await gyro_turn_right(90,medium_speed)
        await motor.run_for_degrees(hammer,-65,medium_speed)
        await gyro_straight(37,medium_speed)
        await gyro_turn_right(65,medium_speed)
      #  await motor.run_for_degrees(hammer,45,medium_speed)
      #  await gyro_back(40,medium_speed)
       # await gyro_turn_right(90,medium_speed)
        await gyro_straight(35,medium_speed)
        #await gyro_turn_left(25,medium_speed)
       # await gyro_straight(62,medium_speed)
        await emergency_stop()
        #await motor.run_for_degrees(hammer,-20,supaslow)
        #await motor.run_for_degrees(hook,3,slow_speed)
        #await motor.run_for_degrees(hammer,285,medium_speed)
